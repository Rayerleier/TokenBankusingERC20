...
contract TokenBank{
    ...
    function deposit(address _constractAdress, uint256 _amount)public returns (bool){
        ...
        (bool allowanceSuccess, bytes memory allowanceData) = _constractAdress.call(
            abi.encodeWithSignature("allowance(address _owner, address _spender)", msg.sender,this)
        );
        ...
        (bool transferSuccess,) = _constractAdress.call(
            abi.encodeWithSignature("transferFrom(address _from, address _to, uint256 _value)", msg.sender, this, _amount)
        );
